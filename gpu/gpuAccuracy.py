...
# Set filepath based on where you store the text file for the Imagenet dataset, which will contain the labels for the ImageNet dataset
text_file = open("Your-path-to-textfile", "r")
