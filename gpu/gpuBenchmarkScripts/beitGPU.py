from transformers import BeitFeatureExtractor, BeitForImageClassification, ResNetForImageClassification
import torch
...
for batch in batch_size:
    ...
    benchmarkDataFrame.loc[index] = ['beit-base-patch16-224', batch, latency_p0, latency_p50, latency_p90, latency_p95, latency_p99, latency_p100, throughput_average, throughputs_peak, cost]
    index += 1



benchmarkDataFrame.to_csv('resnet_gpu_benchmark_100.csv', index = False)
